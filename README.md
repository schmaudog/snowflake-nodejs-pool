snowflake-nodejs-pool (a fork of cyptonote-nodejs-pool)
======================

High performance Node.js (with native C addons) mining pool for CryptoNote based coins. Comes with lightweight example front-end script which uses the pool's AJAX API. Support for Cryptonight (Original, Monero v7, Stellite v7), Cryptonight Light (Original, Aeon v7, IPBC) and Cryptonight Heavy (Sumokoin) algorithms. snowflake-nodejs-pool has been forked and modified specifically for support of mining Snowflake.
...
* Added ability to use `Snowflake-Service` or `Wallet-API`(recommended)
...
* https://pool.snowflake-net.com
* https://frosting-pool.snowflake-net.com
* https://asia-pool.snowflake-net.com
...
Clone the repository and run `npm i` for all the dependencies to be installed:

```bash
git clone https://github.com/Snowflake-coin/cryptonote-nodejs-pool.git pool
cd pool
...
"wallet": {
    "api": true,  //For Snowflake and other turtlecoin derived coins to use the wallet-api daemon set to "true"
    "host": "127.0.0.1",
    "port": 22102,
...
var blockchainExplorer = "https://explorer.snowflake-net.com/block.html?hash={id}";

/* Used by front-end transaction links. */
var transactionExplorer = "https://explorer.snowflake-net.com/transaction.html?hash={id}";
...
* Snowflake (SNW): `SNW1bFWQ2SkffXG9FkXpQCeWAagdmNjY79osPyuEoFWhZiFzVAGXt9kckmJvhcMV97MgegggtmSQWh3mCdRFfFYs3HC89Y8Sfr`
* Bitcoin (BTC): `bc1qvjvwsq04478u5j0rfhp98kgwkg7q86kg5xz60k`
* Litecoin (LTC): `MFVVTJsP4daXJ4YgnNfW238cA26fPHUhMN`
* Dogecoin (DOGE): `DJhTL2GcztfkFC2Fdmx1QN8AY2u88AbPZc`
* Dash (DASH): `XsiUbLMBiwBgWPG1WpUxcZGEQYGrGhjUME`
* PIVX (PIVX): `DDAJME4pmPFHuNeMNn9Y3AJy1w1fSa8wkN`


Credits
---------

* [CryptoCat](//github.com/Snowflake-coin) - Developer on Snowflake Network
